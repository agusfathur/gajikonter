		...
		<div class="card-body">
			<form method="POST" action="<?= base_url('admin/data-divisi/save'); ?>">
				...
				<div class="form-group">
					...
					id="gaji_harian" value="<?= old('gaji_harian'); ?>" >
					<div class="invalid-feedback" >

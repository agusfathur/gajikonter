  ...
  <div class="card-body shadow">
    <form class="form-inline">
      ...
      <div class="form-group mb-2 ml-4">
        ...
        <a class="btn btn-primary mb-2 ml-auto shadow" href="<?= base_url('admin/gaji-perhari/tambah-gaji-harian'); ?>">
        <i class="fa-solid fa-plus"></i> Tambah Gaji Perhari</a>
      </form>
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          <?php $no=1; foreach($gajiPerhari as $gp) : ?>
            <tr style="color:black;">
              <td class="text-center"><?= $no++ ?></td>
              <td class="text-center"><?= $gp['tgl'];?></td>
              <td class="text-center"><?= ucwords($gp['nama_karyawan']);?></td>
              <td class="text-center"><?= ucfirst($gp['divisi']); ?></td>
              <td class="text-center">Rp. <?= number_format($gp['fee'],0,',','.'); ?></td>
              <td class="text-center">Rp. <?= number_format($gp['bonus'],0,',','.'); ?></td>
              <td style="font-size: 13px;"><?= $gp['keterangan']; ?></td>
              <td class="text-center">
                <center>
                  <a class="btn btn-sm btn-info" href="<?= base_url('admin/gaji-perhari/edit-gaji-harian/'.$gp['id_gaji']); ?>">
                    <i class="fa-solid fa-pen-to-square"></i>
                  </a>
                  <a onclick="return confirm('Yakin Hapus?')" class="btn btn-sm btn-danger" 
                  href="<?= base_url('admin/gaji-perhari/delete/'.$gp['id_gaji']); ?>">
      ...
      <?= $pager->links('gaji_perhari', 'gaji_pagination'); ?>
    </div>
  </div>
  </div>
</div>
